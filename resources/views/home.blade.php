...
<html lang="en">
    ...
    <div class="mb-12 space-y-2 text-center">
      {{-- @dump($post) --}}
        <h2 class="text-3xl font-bold text-white-800 md:text-4xl">Latest Articles</h2>
        <p class="lg:mx-auto lg:w-6/12 text-white-600">
      ...
      <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        @foreach($post as $p)
        <div class="group p-6 sm:p-8 rounded-3xl bg-white border border-white-100 bg-opacity-50 shadow-2xl shadow-white-600/10">
