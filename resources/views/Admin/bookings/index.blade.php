...
<body>
    <div class="container">
        ...
        <div style="text-align: center;">
            <a href="{{ route('admin.bookings.create') }}" class="add-button">➕ Tambah Booking Baru</a>
        </div>
            ...
            @forelse ($bookings as $booking)
                <li>
                    ...
                    <div class="action-links">
                        <!-- View Button -->
                        <a href="{{ route('admin.bookings.show', $booking) }}" class="action-button view-button">
                            <span>🔍</span> Detail
                        </a>

                        <!-- Edit Button -->
                        <a href="{{ route('admin.bookings.edit', $booking) }}" class="action-button edit-button">
                            <span>✏️</span> Edit
                        </a>
